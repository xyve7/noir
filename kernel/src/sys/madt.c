...
vector lapics;
vector ioapics;
vector ioapic_overrides;
vector ioapic_nmis;
vector lapic_nmis;
vector lapic_overrides;
vector x2apics;
...
void madt_init() {
    ...
    lapics = vector_new();
    ioapics = vector_new();
    ioapic_overrides = vector_new();
    ioapic_nmis = vector_new();
    lapic_nmis = vector_new();
    lapic_overrides = vector_new();
    x2apics = vector_new();
